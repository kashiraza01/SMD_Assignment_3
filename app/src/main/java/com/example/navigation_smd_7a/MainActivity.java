...
//                AutoCompleteTextView etStatus=v.findViewById(R.id.actvStatus);
//                String[] options = getResources().getStringArray(R.array.autocomplete_options);
//
...
//                        AtomicReference<String> selectedOption = null;
//                        etStatus.setOnItemClickListener((parent, view1, position, id) -> {
//                            selectedOption.set(adapter.getItem(position));
//                        });
//                        // Parse and save the product
//                        ProductDB productDB = new ProductDB(MainActivity.this);
//                        productDB.open();
//                        productDB.insert(title, date, Integer.parseInt(price), String.valueOf(selectedOption));
//                        productDB.close();
//
